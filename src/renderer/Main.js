...
var author$project$Main$AddingChat = function (a) {
	return {$: 'AddingChat', a: a};
};
var author$project$Main$ChatIdentifier = function (a) {
	return {$: 'ChatIdentifier', a: a};
};
...
var author$project$Main$initialModel = function (_n0) {
	return _Utils_Tuple2(
		author$project$Main$AddingChat(
			author$project$Main$ChatIdentifier('cabal://14bc77d788fdaf07b89b28e9d276e47f2e44011f4adb981921056e1b3b40e99e')),
		elm$core$Platform$Cmd$none);
};
var author$project$Main$ChannelAdded = function (a) {
	return {$: 'ChannelAdded', a: a};
};
var author$project$Main$ChatReceived = function (a) {
	return {$: 'ChatReceived', a: a};
};
var elm$json$Json$Decode$andThen = _Json_andThen;
var elm$json$Json$Decode$field = _Json_decodeField;
var elm$json$Json$Decode$string = _Json_decodeString;
var elm$json$Json$Decode$succeed = _Json_succeed;
var author$project$Main$channelAdded = _Platform_incomingPort(
	'channelAdded',
	A2(
		...
		function (name) {
			return A2(
				...
				A2(elm$json$Json$Decode$field, 'chatID', elm$json$Json$Decode$string));
		},
		A2(elm$json$Json$Decode$field, 'name', elm$json$Json$Decode$string)));
var author$project$Main$chatStarted = _Platform_incomingPort('chatStarted', elm$json$Json$Decode$string);
...
var author$project$Main$subscriptions = function (model) {
	switch (model.$) {
		...
		case 'LoadingChat':
			return author$project$Main$chatStarted(
				function (chat) {
					return author$project$Main$ChatReceived(
						author$project$Main$ChatIdentifier(chat));
				});
		case 'LoadingFailing':
			return elm$core$Platform$Sub$none;
		default:
			return author$project$Main$channelAdded(author$project$Main$ChannelAdded);
	}
};
var author$project$Main$Chatting = F2(
	function (a, b) {
		return {$: 'Chatting', a: a, b: b};
	});
var author$project$Main$LoadingChat = {$: 'LoadingChat'};
var elm$json$Json$Encode$string = _Json_wrap;
var author$project$Main$startChat = _Platform_outgoingPort('startChat', elm$json$Json$Encode$string);
var author$project$Main$unwrap = function (chatIdentifier) {
	var id = chatIdentifier.a;
	return id;
};
...
var author$project$Main$update = F2(
	function (msg, model) {
		var res = function () {
			...
			while (true) {
				switch (_n0.a.$) {
					case 'ChatIdentifierChanged':
						if (_n0.b.$ === 'AddingChat') {
							var identifier = _n0.a.a;
							return _Utils_Tuple2(
								author$project$Main$AddingChat(
									author$project$Main$ChatIdentifier(identifier)),
								elm$core$Platform$Cmd$none);
						} else {
							break _n0$4;
						}
					case 'ChatRequested':
						if (_n0.b.$ === 'AddingChat') {
							...
							var id = _n0.b.a;
							return _Utils_Tuple2(
								author$project$Main$LoadingChat,
								author$project$Main$startChat(
									author$project$Main$unwrap(id)));
						} else {
							break _n0$4;
						}
					case 'ChatReceived':
						if (_n0.b.$ === 'LoadingChat') {
							var id = _n0.a.a;
							var _n2 = _n0.b;
							return _Utils_Tuple2(
								A2(author$project$Main$Chatting, id, _List_Nil),
								elm$core$Platform$Cmd$none);
						} else {
							break _n0$4;
						}
					default:
						if (_n0.b.$ === 'Chatting') {
							var addition = _n0.a.a;
							var _n3 = _n0.b;
							var id = _n3.a;
							var channels = _n3.b;
							return _Utils_Tuple2(
								A2(
									author$project$Main$Chatting,
									id,
									_Utils_ap(
										channels,
										_List_fromArray(
...
var author$project$Main$ChatIdentifierChanged = function (a) {
	return {$: 'ChatIdentifierChanged', a: a};
};
var author$project$Main$ChatRequested = {$: 'ChatRequested'};
...
var author$project$Main$viewChannels = function (channels) {
	var _n0 = elm$core$List$isEmpty(channels);
	if (_n0) {
		return _List_fromArray(
			[
				mdgriffith$elm_ui$Element$text('Loading Channels')
			]);
	} else {
		return A2(
			elm$core$List$map,
			function (channel) {
				return mdgriffith$elm_ui$Element$text(channel.name);
			},
			channels);
	}
};
		...
		switch (model.$) {
			case 'AddingChat':
				...
				return A2(
					...
					_List_fromArray(
						[
							mdgriffith$elm_ui$Element$text('Welcome to Cabal'),
							A2(
							...
							_List_Nil,
							{
								label: A2(
									...
									_List_Nil,
									mdgriffith$elm_ui$Element$text('Please enter a chat identifier')),
								onChange: author$project$Main$ChatIdentifierChanged,
								placeholder: elm$core$Maybe$Nothing,
								text: author$project$Main$unwrap(chatIdentifier)
							}),
							A2(
								...
								[mdgriffith$elm_ui$Element$centerX]),
							{
								...
								onPress: elm$core$Maybe$Just(author$project$Main$ChatRequested)
							})
						]));
			case 'LoadingChat':
				return A2(
					...
					_List_fromArray(
						[
							mdgriffith$elm_ui$Element$text('Chat is loading')
						]));
			case 'LoadingFailing':
				var err = model.a;
				return A2(
			...
			default:
				...
				return A2(
					...
					_List_fromArray(
						[
							mdgriffith$elm_ui$Element$text('Chat loaded'),
							...
							mdgriffith$elm_ui$Element$column,
							_List_Nil,
							author$project$Main$viewChannels(channels))
						]));
		}
	}();
	return A2(mdgriffith$elm_ui$Element$layout, _List_Nil, vi);
};
...
_Platform_export({'Main':{'init':author$project$Main$main(
	elm$json$Json$Decode$succeed(_Utils_Tuple0))({"versions":{"elm":"0.19.0"},"types":{"message":"Main.Msg","aliases":{},"unions":{"Main.Msg":{"args":[],"tags":{"ChatIdentifierChanged":["String.String"],"ChatRequested":[],"ChatReceived":["Main.ChatIdentifier"],"ChannelAdded":["{ chatID : String.String, name : String.String }"]}},"Main.ChatIdentifier":{"args":[],"tags":{"ChatIdentifier":["String.String"]}},"String.String":{"args":[],"tags":{"String":[]}}}}})}});}(this));